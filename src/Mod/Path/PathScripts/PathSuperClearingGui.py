...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    def initPage(self, obj):
        self.setTitle("Super Clearing path operation")
...
Resource = PathOpGui.CommandResources('SuperClearing',
        ...
        TaskPanelOpPage,
        'Path-SuperClearing',
        QtCore.QT_TRANSLATE_NOOP("PathSuperClearing", "SuperClearing"),
        QtCore.QT_TRANSLATE_NOOP("PathPocket", "super clearing and profiling"),
        None)

Command = PathOpGui.SetupOperation(Resource, subCmdResources)

FreeCAD.Console.PrintLog("Loading PathSuperClearingGui... done\n")
